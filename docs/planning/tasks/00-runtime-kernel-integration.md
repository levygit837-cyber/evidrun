...
O Runtime Kernel transforma uma Run admitida em uma execucao duravel. A worktree ativa ja ampliou o
escopo original: alem de queue/lease/worker, ela contem um Subject com modelo real, uma read tool
fechada, tracing e Bundle v3. O objetivo desta task nao e adicionar mais capabilities; e transformar
esse trabalho numa integracao coerente com a authority ja mesclada em `main`.
